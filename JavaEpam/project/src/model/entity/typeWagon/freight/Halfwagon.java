 ...
 * This class describes the object of a train Half wagon
 * @see Freight
 */
public class Halfwagon extends Freight {
     ...
     */
    public Halfwagon(double capacity, String model, int weight, int length, double lifetime, int loadingWagon, int goodsInWagon){
        super(weight,length,lifetime,TypeWagon.WAGON_HALFWAGON,loadingWagon,goodsInWagon);
