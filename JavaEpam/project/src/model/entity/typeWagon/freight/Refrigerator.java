 ...
 * This class describes the object of a train Refrigerator wagon
 * @see Freight
 */
public class Refrigerator extends Freight {
     ...
     */
    public Refrigerator(double capacity, String model, int weight, int length, double lifetime, int loadingWagon, int goodsInWagon){
        super(weight,length,lifetime,TypeWagon.WAGON_REFRIGERATOR,loadingWagon,goodsInWagon);
