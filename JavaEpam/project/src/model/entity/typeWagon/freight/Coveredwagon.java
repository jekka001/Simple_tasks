 ...
 * This class describes the object of a train Covered wagon
 * @see Freight
 */
public class Coveredwagon extends Freight {
     ...
     */
    public Coveredwagon(double capacity, String model, int weight, int length, double lifetime, int loadingWagon, int goodsInWagon){
        super(weight,length,lifetime,TypeWagon.WAGON_COVEREDWAGON,loadingWagon,goodsInWagon);
