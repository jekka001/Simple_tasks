 ...
 * This class describes the object of a train Cistern wagon
 * @see Freight
 */
public class Cistern extends Freight {
     ...
     */
    public Cistern(double capacity, String model, int weight, int length, double lifetime, int loadingWagon, int goodsInWagon){
        super(weight,length,lifetime,TypeWagon.WAGON_CISTERN,loadingWagon,goodsInWagon);
