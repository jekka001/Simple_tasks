 ...
 * class SV extends Passenger.
 * The object points to a passenger wagon type SV.
 * @see Passenger
 */
public class SV extends Passenger {
     ...
     */
    public SV(String model, int weight, int length, double lifetime, int numberSeats, int ticketPrice,Map<Integer,Boolean> employment){
        super(weight, length, lifetime, TypeWagon.WAGON_SV, numberSeats, ticketPrice, employment);
        this.model = model;
